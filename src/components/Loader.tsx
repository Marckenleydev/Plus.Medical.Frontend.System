...
const Loader = () => {
  return (
    ...
    <div className="gap-14 flex  items-center justify-center w-full">
        

    <div role="status" className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-300">
