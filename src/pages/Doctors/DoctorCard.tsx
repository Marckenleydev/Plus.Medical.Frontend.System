  ...
  return (
    <div className="p-3 lg:p-5">
        ...
        <div className="mt-2 lg:mt-4 flex items-center justify-between">
            <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">{specialisation}</span>
        
            <div className="flex item-center gap-[6px]">
                <span className="flex items-start gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
        ...
        <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
            ...
            <Link to={`/doctors/${doctorId}`} className="w-[44px] h-[44px] rounded-full border border-solid border-[#181a1e] mt-[30px]
